...
<div class="container-fluid px-8" style="">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Sustained</li>
        </ol>
    </nav>
    <h3 class="dark-blue">Sustained</h3>
    <hr>
    ...
    <div class="container-fluid">
        ...
        <div class="position-relative">
            ...
            <h3>
                    <a class="dark-blue" href="{{URL::route('fast')}}" style="text-decoration: none !important;">
            ...
            <div class="position-absolute top-0 end-0">
                <h3>
                    <a class="dark-blue" href="{{URL::route('medication')}}" style="text-decoration: none !important;">
                        <span class="material-icons md-48 dark-blue" style="font-size: 35px !important" >
                            arrow_circle_right
                        </span>
                        <br>
