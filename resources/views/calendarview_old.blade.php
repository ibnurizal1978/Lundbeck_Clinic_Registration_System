                        ...
                        @if (count($todays) > 0)
                            @foreach ($todays as $today)
                                <li class="list-group-item px-2">
                                    <h5 class="card-title">
                                        <i class="fa fa-circle {{ $today->session_status == '0' ? 'apt-pending' : ($today->session_status == '1' ? 'apt-accepted' : 'apt-completed') }} "
                                            aria-hidden="true"></i>
                    ...
                    data.forEach((element) => {
                        ...
                        if (selected_date_formatted == moment(event_date).format('YYYY-MM-DD') && (element
                            ...
                            var inside_html =
                                '   <li class="list-group-item px-2">' +
                                '       <h5 class="card-title">' +
                                '           <i class="fa fa-circle ' + status_dot +
                            ...
                            inside_html += '<br/>' + 'Created On: ' + moment(element.extendedProps
                                .created_at).format(
                                "DD MMMM YYYY");
                            inside_html += '</p>' +
                                '       <div class="d-grid gap-2">';
                            ...
                            if (role == "4" || role == "2" || (role == "1" && (element.extendedProps
                                ...
                                if (element.extendedProps.status == "2") {
                                    ...
                                    if (moment().format('MM-DD-YYYY') == element.extendedProps
                                        .session_date) {
                                        inside_html +=
                                            '           <button class="btn btn-vyepti-teal fc-vyepti-steel-20 btn-sm" ' +
