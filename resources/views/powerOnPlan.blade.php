            ...
            <div class="col-xs-12 col-md-10 col-lg-8 col-xl-6 mb-5">
                <div class="card">
                    <div class="card-body m-0 p-0">
                        <form method="POST" action="{{ route('createPSP') }}" id="id">
                            @csrf
                            ...
                            <div class="px-5 py-4">
                                ...
                                <div
                                    @if (auth()->user()->role_id == 4) class='row mb-3' @else class='row mb-3' @endif>
                                    <label for="clinic" class=" col-form-label text-md-right mt-0 pt-0">Clinic <span
                                            class="text-danger">*</span></label>
                                    <div class="col">

                                        <!-- added by Rizal for slide 10 -->
                                        @if (auth()->user()->role_id == 1)
                                            @foreach ($clinics as $clinic)
                                                    @if ($clinic->id == auth()->user()->clinic_id || $clinic->id == old('clinic_id')) 
                                            ...
                                            @endforeach
                                        @else
                                        <!-- end added by Rizal for slide 10 -->
                                        <select class="form-select @error('clinic') is-invalid @enderror" id="clinic_id"
                                            name="clinic_id" required>
                                ...
                                <div class="row mb-3">
                                    <!-- added by Rizal for slide 16 -->
                                    <input class="form-check-input patient_status" type="hidden" id="new"
