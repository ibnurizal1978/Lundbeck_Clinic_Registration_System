...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('patientCode', [App\Http\Controllers\AppointmentController::class, 'patientCode'])->name('patientCode');
    /* end added by Rizal */
    ...
    Route::post('report/reportFilter', [App\Http\Controllers\PatientController::class, 'reportFilter'])->name('reportFilter');
    ...
    Route::post('report/patientSummaryFilter', [App\Http\Controllers\ReportController::class, 'patientSummaryFilter'])->name('patientSummaryFilter');
...
Route::get('sendsmstest', [App\Http\Controllers\TwilioSMSController::class, 'sendsmstest']);

//cron
Route::get('emailCron', [App\Http\Controllers\CronController::class, 'emailCron']);

//test send email
Route::get('emailTest', [App\Http\Controllers\CronController::class, 'emailTest']);