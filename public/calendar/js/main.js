...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    StandardTheme.prototype.classes = {
        ...
        button: 'fc-button fc-button-primary btn-light btn-light-blue btn-circle',
    ...
    var ToolbarSection = /** @class */ (function (_super) {
        ...
        ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
            ...
            for (var _i = 0, widgetGroup_1 = widgetGroup; _i < widgetGroup_1.length; _i++) {
                ...
                if (buttonName === 'title') {
                    isOnlyButtons = false;
                    children.push(createElement("h2", { className: "fc-toolbar-title mx-2 fc-vyepti-teal fs-5 fw-bold", id: props.titleId }, props.title));
                }
                else {
        ...
        */
        CalendarContent.prototype.render = function () {
            ...
            return (createElement(ViewContextType.Provider, { value: viewContext },
                toolbarConfig.header && (createElement(Toolbar, __assign({ ref: this.headerRef, extraClassName: "fc-header-toolbar mt-3", model: toolbarConfig.header, titleId: viewLabelId }, toolbarProps))),
            ...
            return (createElement(RenderHook, { hookProps: hookProps, classNames: options.dayHeaderClassNames, content: options.dayHeaderContent, defaultContent: renderInner$1, didMount: options.dayHeaderDidMount, willUnmount: options.dayHeaderWillUnmount }, function (rootElRef, customClassNames, innerElRef, innerContent) { return (createElement("th", __assign({ ref: rootElRef, role: "columnheader", className: classNames.concat(customClassNames).join(' '), colSpan: props.colSpan }, props.extraDataAttrs),
                createElement("div", { className: "fc-scrollgrid-sync-inner" },
                    createElement("a", { "aria-label": dateEnv.format(date, WEEKDAY_FORMAT), className: [
                            'fc-col-header-cell-cushion text-uppercase text-decoration-none fc-vyepti-teal',
                            props.isSticky ? 'fc-sticky' : '',
    ...
    */
    ...
    var TableCellTop = /** @class */ (function (_super) {
        ...
        TableCellTop.prototype.render = function () {
            ...
            return (createElement(DayCellContent, { date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, showDayNumber: props.showDayNumber, extraHookProps: props.extraHookProps, defaultContent: renderTopInner }, function (innerElRef, innerContent) { return ((innerContent || props.forceDayTop) && (createElement("div", { className: "fc-daygrid-day-top", ref: innerElRef },
                createElement("a", __assign({ id: props.dayNumberId, className: "fc-daygrid-day-number text-decoration-none fc-vyepti-teal" }, navLinkAttrs), innerContent || createElement(Fragment, null, "\u00A0"))))); }));
        };
        return TableCellTop;
    }(BaseComponent));
    ...
    function renderInnerContent$2(innerProps) {
        var status_dot;
        switch (innerProps.event.extendedProps.status) {
            case 0:
                status_dot = "apt-pending-dot";
                break;
            case 1:
                status_dot = "apt-accepted-dot";
                break;
            case 2:
                status_dot = "apt-completed-dot";
                break;
            default:
                status_dot = "apt-rejected-dot";
        }

        var cont = createElement(Fragment, null,
            createElement("div", { className: "fc-daygrid-event-dot " + status_dot, style: { borderColor: innerProps.borderColor || innerProps.backgroundColor } }),
            innerProps.timeText && (createElement("div", { className: "fc-event-time fc-vyepti-teal" }, innerProps.timeText)),
            createElement("br"),
            createElement("div", { className: "fc-event-title fc-vyepti-teal patient_name" }, innerProps.event.title || createElement(Fragment, null, "\u00A0"))
            );
