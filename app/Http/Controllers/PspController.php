...
class PspController extends Controller
{
    ...
    public function createPsp(Request $request)
    {
        ...
        $subject = "New Patient Enrolled Onto Power On Treatment Plan (UAT)";
        ...
        if (env('SEND_SMS')) {
            ...
            app('App\Http\Controllers\TwilioSMSController')->sendSMSCC("(UAT) A new patient has been enrolled onto power on treatment plan by [" . $clinic->psp_code . "][" . $clinic->name . "]");
        }
