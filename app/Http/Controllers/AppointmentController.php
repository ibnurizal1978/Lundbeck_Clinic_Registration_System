...
class AppointmentController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        $clinic = DB::table('appointments')
            ...
            ->where('appointments.id', $details[0]->appointment_id)->get()->toArray();
    ...
    public function UpdateRemarks(Request $request)
    {
        ...
        $message = $start . "<br/><br/>" . $appointment_info;
         ...
         if (env('SEND_SMS')) {
            ...
            app('App\Http\Controllers\TwilioSMSController')->sendSMSCC($subject." - ".$start."by [" . $details->clinic_name . "]");
        }
    ...
    public function CreateAppointment(Request $request)
    {
        if (auth()->user()->role_id == 1 || auth()->user()->role_id == 4 || auth()->user()->role_id == 5) {
            ...
            $patients = Patient::where('status', 1)->orderBy('name', 'asc')->get(['id', 'patient_code', 'name', 'clinic_id']); //added by Rizal for slide 10 -> add 'patient_code'
    ...
    public function confirm_appointment(Request $request)
    {
        ...
        $details = DB::table('sessions')
            ...
            /*** added by Rizal for slide 11, just change from $auth() to auth()
             */
        $appointment_info =  "<html>
                                    <head></head>
                                    <body>
        ...
        // send email
        app('App\Http\Controllers\MailerController')->sendemail($subject, $message, $clinic, $staffs);
        /*** End Added by Rizal fro slide 6 */
    ...
    public function patientCode(Request $r)
    {
        $id = $r->id;
        ...
        return view('patientCode', ['data' => $data]);
    }
    /* end added by Rizal */
}
