    ...
    public function index()
    {
        if(auth()->user()->role_id == 3 || auth()->user()->role_id == 4)
        {
            $patients =  DB::table('patients')->leftJoin('clinics', function ($join) {
                ...
                'patients.id', 'patients.name', 'patients.nric', 'patients.clinic_id', 'clinics.name as clinic_name', 'patients.psp_reg',
                'psp.code as patient_code', 'patients.status', 'patients.created_at', 'patients.updated_at'
            ]);
